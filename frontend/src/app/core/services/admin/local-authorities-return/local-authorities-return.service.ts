...
export class LocalAuthoritiesReturnService {
  ...
  public getDates(): Observable<SetDates> {
    return this.http.get<SetDates>(
      'https://a3akknuhui.eu-west-1.awsapprunner.com/api/admin/local-authority-return/dates',
    );
  }

  public setDates(dates: SetDates): Observable<SetDates> {
    return this.http.post<SetDates>(
      'https://a3akknuhui.eu-west-1.awsapprunner.com/api/admin/local-authority-return/dates',
      dates,
    );
  }
  ...
  public getLAs(): Observable<LAs> {
    return this.http.get<LAs>('https://a3akknuhui.eu-west-1.awsapprunner.com/api/admin/local-authority-return/monitor');
  }

  public getLA(localAuthorityId: string): Observable<IndividualLA> {
    return this.http.get<IndividualLA>(
      `https://a3akknuhui.eu-west-1.awsapprunner.com/api/admin/local-authority-return/monitor/${localAuthorityId}`,
    );
  }
  ...
  public resetLAs(): Observable<LAs> {
    return this.http.put<LAs>(
      `https://a3akknuhui.eu-west-1.awsapprunner.com/api/admin/local-authority-return/monitor/reset`,
      {},
    );
  }
}
