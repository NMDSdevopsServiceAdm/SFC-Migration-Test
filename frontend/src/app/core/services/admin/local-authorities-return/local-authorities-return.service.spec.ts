...
describe('LocalAuthoriesReturnService', () => {
  ...
  it('should get the previous local authority return dates', () => {
    ...
    const req = http.expectOne('https://a3akknuhui.eu-west-1.awsapprunner.com/api/admin/local-authority-return/dates');
  ...
  it('should get a list of all of the local authorities', () => {
    ...
    const req = http.expectOne(
      'https://a3akknuhui.eu-west-1.awsapprunner.com/api/admin/local-authority-return/monitor',
    );
